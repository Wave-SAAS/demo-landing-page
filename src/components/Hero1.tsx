  ...
  return (
    <section className="px-4 py-16 text-center max-w-3xl mx-auto">
      ...
      <p className="text-lg text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
        Wave is an AI-powered SaaS platform that bridges your customer data and
        email providers to deliver smart segmentation and detailed bulk mailing.
        With Wave, you can send personalized email campaigns using templates
